...
<html lang="en" style="scroll-behavior: smooth;">
    ...
    <body>
      <script src="https://www.gstatic.com/firebasejs/5.9.1/firebase-app.js"></script>
        ...
        <script src="js/intern/data.js?v=2"></script>
        ...
        <script>
          $(document).ready(function(){
            ...
            setTimeout(function(){$('.parallax-window').parallax({imageSrc: 'img/perro_walk_2.jpg'});},4500)
                ...
                <div class="row" style="margin-top: 20px;">
                  <div class="col-md-6 col-sm-12 col-xs-12">
                    <p class="text-white" style="font-size: 20px;font-weight: bold;">
                      El Centro Canino se encuentra a 4 km, de la gasera y gasolinera de Los Saúcos, rumbo a Temazcaltepec, tomando en la "Y" el camino de la izquierda. 
                      <br><br>
